$(document).ready(function() {
  ...
  function checkTime() {
    //condition to check current time for  1200 Hrs and update the background color for the textrarea
      ...
      //condition to check current time for  1300 Hrs and update the background color for the textrarea
      ...
      //condition to check current time for 1400 Hrs and update the background color for the textrarea
      ...
      // condition to check current time for 1500 Hrs and update the background color for the textrarea
      ...
      // condition to check current time for 1600 Hrs and update the background color for the textrarea
      ...
      // condition to check current time for  1700 Hrs and update the background color for the textrarea
      ...
      // condition to check current time for  900 Hrs and update the background color for the textrarea
     ...
     // condition to check current time for 1000 Hrs and update the background color for the textrarea
      ...
      // condition to check current time for 1100 Hrs and update the background color for the textrarea
